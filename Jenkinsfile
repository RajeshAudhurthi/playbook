...
stage('Artifactory'){
    sh "curl -u admin:Jfrog#77 -T /var/lib/jenkins/workspace/gol10/game-of-life/gameoflife-web/target/*.war http://65.0.7.196:8082/artifactory/gol1/gameoflife.war"
}
